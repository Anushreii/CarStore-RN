...
import NewFilterScreen from "./FilterTabs/NewFilterScreen";
...
{/* bottom  bar */}
      ...
      >
        ...
        >
          <View style={{ height: '67%', marginTop: 100, marginHorizontal: 20, width:"85%", borderRadius:10, borderBottomEndRadius:10, }}>
